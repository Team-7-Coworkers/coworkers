  ...
  return (
    <div className="relative w-full text-center">
      <Image
        ...
        priority
      />
      <div className="absolute top-[55px] flex w-full flex-col items-center gap-1 sm:top-[30px] sm:gap-2 lg:top-[44px] lg:gap-5">
      ...
      <Link href="/login">
        <motion.button
          className="relative bottom-12 w-[343px] rounded-[32px] bg-gradient-to-r from-primary to-tertiary py-[13px] text-lg font-semibold sm:bottom-[70px] sm:w-[373px] sm:py-[14.5px]"
